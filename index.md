...
titleDisplay: "State of Our Networks 2017 <br /> Mini-Conference"
...
<a class="button button-primary" href="mailto:{{ site.email }}?subject=State of Our Networks Registration" role="link">{% include icons/ticket.svg %}&nbsp;Register Now</a>
...
<ul class="bio-sm-list">
  <li class="bio-sm-list-item"><a href="https://garrying.com/" target="_blank">{% include icons/link.svg %}&nbsp;garrying.com</a></li>
...
<ul class="bio-sm-list">
  <li class="bio-sm-list-item"><a href="http://karenlouisesmith.net/" target="_blank">{% include icons/link.svg %}&nbsp;karenlouisesmith.net</a></li>
