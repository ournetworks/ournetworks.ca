...
<tr>
  ...
  <td colspan="1" rowspan="16" class="session-block session-{% include session-type.html session-id=19018 %} overlap">{% include session.html year=2019 session-id=19018 %}[Note: workshop has $60 materials fee]</td>
</tr>
<tr>
  <td></td>
  <td>:15</td>
